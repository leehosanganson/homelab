...
> For the full step-by-step operations guide, see [docs/runbooks/iac-terraform-opentofu-provisioning.md](docs/runbooks/iac-terraform-opentofu-provisioning.md).
...
For step-by-step procedures, SOPs, and recurring processes, refer to **[docs/runbooks/workflows-testing-validation.md](docs/runbooks/workflows-testing-validation.md)**. This index includes actionable workflows such as testing PR branches in-cluster via FluxCD without merging to main.
