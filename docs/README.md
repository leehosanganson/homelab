...
- [runbooks/pihole-vm-migration.md](runbooks/pihole-vm-migration.md) — Migrating the Pi-hole VMs from native PVE VMs to the NixOS IaC framework (inspect, cutover, node mobility)
