...
|              <img src="https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/coder.svg" height="32"/>               | [Coder](https://github.com/coder/coder)                                      | Self-hosted cloud development environment platform          |
...
|      <img src="https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/vllm.svg" height="32" />      | [vLLM](https://github.com/vllm-project/vllm)                           | High-throughput GPU-accelerated LLM inference engine        |
...
|           <img src="https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/harbor.svg" height="32" />           | [Harbor](https://github.com/goharbor/harbor)                              | Self-hosted container registry with image scanning and proxy caching  |
|           <img src="https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/velero.svg" height="32" />           | [Velero](https://github.com/vmware-tanzu/velero)                          | Kubernetes backup and disaster recovery                       |
|          <img src="https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/renovate.svg" height="32" />          | [Renovate](https://github.com/renovatebot/renovate)                       | Automated dependency update bot (runs as a CronJob)           |
|                                                                                                                       | [Metrics Server](https://github.com/kubernetes-sigs/metrics-server)       | Kubernetes resource usage metrics for kubectl top             |
|           <img src="https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/rancher.svg" height="32" />          | [Rancher](https://github.com/rancher/rancher)                             | Kubernetes management platform and UI                         |
