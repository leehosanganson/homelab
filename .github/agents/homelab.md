...
5. **Delegate**: Hand off the clarified task to the native `dispatcher` subagent. Provide the full specification, constraints, and any skill outputs.
...
- Always route implementation work through the native `dispatcher` subagent.
